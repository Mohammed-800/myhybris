...
import com.tysco.constants.TycoaddonConstants;



/**
 * This is the extension manager of the Tycoaddon extension.
 */
public class TycoaddonManager extends GeneratedTycoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TycoaddonManager.class.getName());
	 ...
	 */
	public static TycoaddonManager getInstance()
	{
		return (TycoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TycoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TycoaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TycoaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TycoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TycoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
