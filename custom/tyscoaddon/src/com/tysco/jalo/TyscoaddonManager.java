...
/**
 * This is the extension manager of the Tyscoaddon extension.
 */
public class TyscoaddonManager extends GeneratedTyscoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TyscoaddonManager.class.getName());
	 ...
	 */
	public static TyscoaddonManager getInstance()
	{
		return (TyscoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TyscoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TyscoaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TyscoaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TyscoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TyscoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
